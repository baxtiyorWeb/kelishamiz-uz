...
const Banner = () => {
  ...
  const slides = [
    {
      id: 1,
      imageUrl: "https://olcha.uz/image/original/sliders/oz/cdn_1/2025-02-13/z2C7Ar56VK4CTVLlEtYDEreM61Kg6hXzFQXRbmqqoiO0eyAtYFFVrp9RM6oG.png",
      title: "Summer Sale",
  ...
  return (
    <div 
      className="relative mx-auto my-4 md:my-6 w-full overflow-hidden rounded-lg"
    ...
    >
      <div 
        className="flex h-[200px] sm:h-[250px] md:h-[300px] lg:h-[382px] transition-transform duration-500 ease-out"
